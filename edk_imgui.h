...
inline void ImGuiInit(GLFWwindow* window, float window_width, float window_height) {
...
inline void WindowMakeResizable(GLFWwindow* window) {
...
inline void WindowMakeBorderless(GLFWwindow* window) {
  HWND hwnd = glfwGetWin32Window(window);
  LONG_PTR style = GetWindowLongPtr(hwnd, GWL_STYLE);
